...
export async function POST(req: NextRequest) {
  try {
    ...
    for (let i = 0; i < meals.length; i++) {
      ...
      // Fresh recipe branch — deduped against the user's existing
      // auto-generated recipes so a Regenerate doesn't produce a
      // duplicate row for "Sheet pan chicken thighs" etc.
      const r = m.recipe;
      if (!r) continue;
